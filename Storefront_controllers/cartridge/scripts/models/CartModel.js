...
var CartModel = AbstractModel.extend({
    ...
    /**
     * Creates new ProductLineItems and Shipments from the list of address selections with the help of
     * a data structure. The data structure contains address relationship HashMap that contains a product relationship HashMap.
     *
     * The following example has an address relationship map that contains a two product relationship maps, named product1 and product2.
     * The product1 relationship map contains two products and their quantities.
     * <table class=params>
     * <b>address relations map:</b>
     * <tr><td><b>Key</b></td><td><b>Value</b></td></tr>
     * <tr><td>address1</td><td>products1</td></tr>
     * <tr><td>address2</td><td>products2</td></tr>
     * </table>
     *
     * <b>products1 product relations map:</b>
     * <table class=params>
     * <tr><td><b>Key</b></td><td><b>Value</b></td></tr>
     * <tr><td>productsID1</td><td>quantity1</td></tr>
     * <tr><td>productsID2</td><td>quantity2</td></tr>
     * </table>
     *
     * @transactional
     * @alias module:models/CartModel~CartModel/mergeQuantities
     * @param {dw.web.FormList} quantityLineItems
     * @returns {boolean} Boolean that is false in the case of an error, true otherwise.
     */
    mergeQuantities: function (quantityLineItems) {
        ...
        for (var x = 0; x < addresses.length; x++) {
            ...
            productRelations = addressRelations.get(address);
